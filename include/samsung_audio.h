...
#define SOUND_PLAYBACK_SCO_DEVICE 22

/* Capture */
#define SOUND_CAPTURE_DEVICE 9
#define SOUND_CAPTURE_SCO_DEVICE 22

/* Voice calls */
#define SOUND_PLAYBACK_VOICE_DEVICE 4
#define SOUND_CAPTURE_VOICE_DEVICE 10
